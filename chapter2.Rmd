...
Next I have summmarized the data both in text and visually. The age of the participants varied between 17 and 55 (mean 25,51), the exam points varied between 7 and 33 (mean 22.72). 
```{r}
summary(students2014)
```
                        age           attitude    
 Length:166         Min.   :17.00   Min.   :1.400  
 Class :character   1st Qu.:21.00   1st Qu.:2.600  
 Mode  :character   Median :22.00   Median :3.200  
                    Mean   :25.51   Mean   :3.143  
                    3rd Qu.:27.00   3rd Qu.:3.700  
                    Max.   :55.00   Max.   :5.000  
...
![summary of the fitted model](/image/rplot03.png "This is summary of the fitted model")
...
![residuals vs fitted](/image/rplot05.png "This is residuals vs. fitted")
This looks quite nice to me, as the distance of the observations from the fitted line is about the same on the left as on the right
![normal q-q](/image/rplot06.png "This is normal q-q")
Here at the right end of the image the residuals diverge from the straight line, so this is not normally distributed totally. As I don't have much experience in this, I don't know whether this is a problem or not as most of this fits the line nicely
![residuals vs leverage](/image/rplot07.png "This is residuals vs leverage")
